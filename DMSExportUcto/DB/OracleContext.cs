...
using DMSExportUcto.Data;
using DMSExportUcto.Log;
using DMSExportUcto.Security;
...
namespace DMSExportUcto.DB
{
    ...
    public class OracleContext : IDisposable
    {
        ...
        public OracleContext(bool startTransaction)
            : this(string.Empty, startTransaction)
        {
        }
        ...
        private void CreateConnection(string connectionString, bool startTransaction)
        {
            ...
            string connStr = (string.IsNullOrEmpty(connectionString)) ? GetDefaultConnectionString() : connectionString;
